...
public class UpdateReportDashboardItemCommandValidator : AbstractValidator<UpdateReportDashboardItemCommand>
{
    public UpdateReportDashboardItemCommandValidator()
    {
        RuleFor(x => x.Id)
