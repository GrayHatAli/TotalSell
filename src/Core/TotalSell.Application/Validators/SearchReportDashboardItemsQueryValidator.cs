...
public class SearchReportDashboardItemsQueryValidator : AbstractValidator<SearchReportDashboardItemsQuery>
{
    public SearchReportDashboardItemsQueryValidator()
    {
